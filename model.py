...
class ResNet9Dec(nn.Module):
    ...
    def __init__(self, 
        ...
        self.fc = nn.Sequential(nn.Linear(latent_dim, 512),
                                Reshape((-1, 512, 1, 1)),
...
class SparseAutoencoder(nn.Module):
    ...
    def __init__(self, 
        ...
        """ """
        self.encoder = ResNet9Enc(in_channels, latent_dim, k, k_percent)
        self.decoder = ResNet9Dec(in_channels, latent_dim)
