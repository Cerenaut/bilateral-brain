...
from models.resnet_v1 import resnet9, invresnet9
...
class SupervisedLightningModule(LightningModule):
    ...
    def _initialize_model(self):
        ...
        if self.config['hparams']['inverse']==0:
            self.model = resnet9(args)
        elif self.config['hparams']['inverse']==1:
...
#inverse
class inverseSupervisedLightningModule(LightningModule):
    def __init__(
        self,
        config: Optional[Dict],
        **kwargs
