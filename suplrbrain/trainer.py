...
def main() -> None:
    ...
    config['logger']['version'] =f'lr={lr}|opt=adam|latent_dim={latent_dim}|'
    ...
    dest_dir = os.path.join(config['logger']['save_dir'], config['logger']['name'], f"version_{config['logger']['version']}")
    ...
    imdm = DataModule(
        ...
        val_dir='/home/chandramouli/Documents/kaggle/CIFAR-100-Coarse/val',
