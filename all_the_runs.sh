...
python train_system.py --arch vgg11 --num_seeds 5 --epochs 180 180 100 --uni_base_config configs/config_unilateral_specialize.yaml --bi_base_config configs/config_bilateral_specialized.yaml
